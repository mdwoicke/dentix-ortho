#!/usr/bin/env node
/**
 * Update the schedule_appointment_dso_Tool.json with v44 func code
 */

const fs = require('fs');
const path = require('path');

const JSON_PATH = path.join(__dirname, '../../docs/v1/schedule_appointment_dso_Tool.json');
const FUNC_PATH = path.join(__dirname, '../../docs/v1/scheduling_tool_func.js');
const ESCAPED_PATH = path.join(__dirname, '../../docs/v1/scheduling_tool_func_escaped.js');

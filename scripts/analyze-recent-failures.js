...
async function main() {
    ...
    try {
        ...
        const runs = query(db, `
            SELECT run_id, started_at, tests_completed, tests_passed, tests_failed
            FROM test_runs
        ...
        for (const run of runs) {
            ...
            console.log(`  Completed: ${run.tests_completed}, Passed: ${run.tests_passed}, Failed: ${run.tests_failed}`);
        }
